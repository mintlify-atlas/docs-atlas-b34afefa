---
title: "Resolving Coordinates to Panama's Political Divisions"
sidebarTitle: "Location Data"
description: "Resolve coordinates to Panama's five administrative levels — province through neighborhood — using local GeoJSON files or the official remote API."
---
...
| File | Level | Name property | ID property |
|------|-------|---------------|-------------|
