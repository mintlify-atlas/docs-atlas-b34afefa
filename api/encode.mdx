...
# Default: full PICO encoding
cuerpo = encode(8.305509375, -79.20167109375001)
print(cuerpo)  # 'M2C9A-F9A33'

# MACRO only — coarsest resolution, 2 characters
macro = encode(8.305509375, -79.20167109375001, level="MACRO")
print(macro)   # 'M2'  (2 chars, ~15.8 km precision)

# MICRO — 4 characters, no hyphen
micro = encode(8.305509375, -79.20167109375001, level="MICRO")
print(micro)   # 'M2C9'  (4 chars, ~660 m precision)

# NANO — 6-character body, formatted as XXX-XXX
nano = encode(8.305509375, -79.20167109375001, level="NANO")
print(nano)    # 'M2C-9AF'  (7 chars with hyphen, ~26 m precision)
